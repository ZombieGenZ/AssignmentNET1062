<template>
  <div class="min-h-[70vh] flex bg-slate-50">
    <aside class="w-64 bg-slate-900 text-slate-100 shadow-2xl">
      ...
      <div class="px-6 py-4 text-[11px] text-slate-500 border-t border-slate-800">
        Trợ giúp: support@fastfood.vn
      </div>
    </aside>
    <main class="flex-1">
      <div class="px-8 py-8">
